(function() {
    ...
    medicosService.$inject = ['$http','$location','$q','$resource','exception','servicios','$timeout'];
    function medicosService($http, $location, $q,$resource,exception,servicios,$timeout) {
        var resource = $resource('/Medicos',{}, { 
            'get':    {method:'GET'},
